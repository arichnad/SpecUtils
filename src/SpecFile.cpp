...
{ 
  ...
  if( sample_nums.empty() )
    cerr << "No sample numbers were specified to write out" << endl;
  
  if( det_nums.empty() )
    cerr << "No detector numbers were specified to write out" << endl;
  ...
  if( info.measurements_.empty() )
    cerr << "No Measurements to write out" << endl;
